...
import { invoke } from 'packages/form-create/coreSrc/frame/util';
    ...
    submit(successFn, failFn) {
      api.validate((valid) => {
        if (valid) {
          ...
          if (is.Function(successFn)) invoke(() => successFn(formData, this));
          else {
            is.Function(h.options.onSubmit) &&
              invoke(() => h.options.onSubmit(formData, this));
