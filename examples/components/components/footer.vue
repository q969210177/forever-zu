    ...
    <div class="container">
        <div class="footer-main">
            <h4>{{ langConfig.links }}</h4>
             <a href="https://github.com/q969210177/forever-zu" class="footer-main-link" target="_blank">{{ langConfig.repo }}</a>
             <a href="https://github.com/q969210177/foveverDoc" class="footer-main-link" target="_blank">文档地址</a>
